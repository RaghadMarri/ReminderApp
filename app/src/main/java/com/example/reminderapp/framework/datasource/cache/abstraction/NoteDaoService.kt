package com.example.reminderapp.framework.datasource.cache.abstraction

import com.example.reminderapp.business.domain.model.Note
import com.example.reminderapp.framework.datasource.database.NOTE_PAGINATION_PAGE_SIZE
